#author: https://github.com/franapoli/signed-ks-test/blob/master/signed-ks-test.R
FUNCTIONS = """
ks_test_2 <- function (x, y, ..., alternative = c("two.sided", "less", "greater"), exact = NULL, maxCombSize=10000)
{
